...
import { faStar, faHeart, faComment, faShare, faTrash } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className="review-card">
      ...
      {review.images.length > 0 && (
        <div className="review-images">
          {review.images.map((img, index) => (
            <img key={index} src={img} alt={`Review image ${index + 1}`} className="review-image" />
          ))}
        </div>
      )}
      <div className="review-actions">
        ...
        <div className="review-action" onClick={onDelete} style={{ color: 'red', cursor: 'pointer' }}>
